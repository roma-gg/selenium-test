...
public class AP_Utility {
    ...
    public static void login(WebDriver driver, SoftAssert softAssert) {
        driver.get("https://automationexercise.com");
        softAssert.assertTrue(driver.findElement(By.tagName("body")).isDisplayed(), "main page is not loaded");
    ...
    public static void login(WebDriver driver, SoftAssert softAssert, String email, String password) {
        driver.get("https://automationexercise.com");
        softAssert.assertTrue(driver.findElement(By.tagName("body")).isDisplayed(), "main page is not loaded");
